...
MAX_VAL = 1.5 # ranges larger in distance than this are set to this
CLOSE_ENOUGH_TO_GOAL = .5
MAX_VAL_PRECISION = 1e-3 # precision around max
MIN_CLEARANCE_ALLOWED = 1.5 # set to approximate width of robot
MIN_EDGE_CLEARANCE = 1.5 # clearance that must be met before added additional directions to a gap
