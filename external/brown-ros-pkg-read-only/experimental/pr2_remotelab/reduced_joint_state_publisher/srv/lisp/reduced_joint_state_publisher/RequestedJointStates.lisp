...
(in-package reduced_joint_state_publisher-srv)
...
(defmethod ros-datatype ((msg (eql '<RequestedJointStates-request>)))
  ...
  "reduced_joint_state_publisher/RequestedJointStatesRequest")
...
(defmethod ros-datatype ((msg (eql '<RequestedJointStates-response>)))
  ...
  "reduced_joint_state_publisher/RequestedJointStatesResponse")
...
(defmethod ros-datatype ((msg (eql 'RequestedJointStates)))
  ...
  "reduced_joint_state_publisher/RequestedJointStates")
