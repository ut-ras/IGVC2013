dojo.provide("blocknlp.THREEVisualiser");

dojo.require("blocknlp.lib.Three", true);
dojo.require("blocknlp.lib.SphereMountedCamera", true);

dojo.require("dijit._Widget");

dojo.declare("blocknlp.THREEVisualiser", dijit._Widget, {
