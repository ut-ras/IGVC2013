dojo.provide("blocknlp.BlockVisualiser");

dojo.require("blocknlp.THREEVisualiser");

dojo.declare("blocknlp.BlockVisualiser", blocknlp.THREEVisualiser, {
    ...
    addBlock: function(x, y, z, rotZed) {
        var materials = [];
        for (var i = 0; i < 6; i++) {
