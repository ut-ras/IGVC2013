...
echo "*"
echo "**********************************************************"
echo "*          OVERHEAD START SCRIPT - LEFT CAMERA           *"
echo "*                                                        *"
echo "* Please make sure you set left camera parameters below  *"
echo "**********************************************************"
echo "*"
echo "*"
...
echo "    camera parameters (left camera):"
echo "Exposure: 50"
echo "Main gain: 5"
echo "*"
echo "*"
