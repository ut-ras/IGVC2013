...
#            rospy.Subscriber("position", Position, self.debug_track)
    ...
    def pushGoal(self, newGoal):
        ...
        print "pushing a goal onto the stack...", newGoal.str()
        ...
        print "resulting in force: ", goalForce.str()
    ...
    def setGoal(self, newGoal):
        ...
        print "  ==> we are here just now: (%.3f, %.3f, %.3f)" % tuple(self.position)
        self.pushGoal(g)
    ...
    def doMove(self, belief):
        ...
        if self.lost():
            ...
            print "doing a force move after all"
