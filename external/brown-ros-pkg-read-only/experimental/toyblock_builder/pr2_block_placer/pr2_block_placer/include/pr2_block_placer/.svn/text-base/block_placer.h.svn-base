...
class BlockPlacer 
{
  ...
  public:
    ...
    void moveArmToPrePlacePose(int x,int y,int z, geometry_msgs::Quaternion orientation);
    void moveArmToPlacePose(int x,int y,int z, geometry_msgs::Quaternion orientation);
