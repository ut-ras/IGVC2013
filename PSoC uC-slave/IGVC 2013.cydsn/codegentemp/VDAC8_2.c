...
uint8 VDAC8_2_initVar = 0;

#if (CY_PSOC5_ES1)
uint8 VDAC8_2_restoreVal = 0;
uint8 VDAC8_2_intrStatus = 0u;
#endif /* CY_PSOC5_ES1 */
...
void VDAC8_2_Enable(void) 
{
    ...
    #if (CY_PSOC5_ES1)
    if ( VDAC8_2_restoreVal == 1) 
    {
         VDAC8_2_CR0 = VDAC8_2_backup.data_value;
         VDAC8_2_restoreVal = 0;
    }
    #endif
}
...
{
   VDAC8_2_CR0 &= ~VDAC8_2_RANGE_MASK ;      /* Clear existing mode */
...
void VDAC8_2_SetValue(uint8 value) 
{
   ...
   #if (CY_PSOC5_ES1)
       VDAC8_2_intrStatus = CyEnterCriticalSection();
   #endif /* CY_PSOC5_ES1 */
...
void VDAC8_2_DacTrim(void) 
{
    ...
    mode = ((VDAC8_2_CR0 & VDAC8_2_RANGE_MASK) >> 2) + VDAC8_2_TRIM_M7_1V_RNG_OFFSET;
