...
***************************************/
 ...
 /* Default DAC range */
#define VDAC8_1_DEFAULT_RANGE    4
 /* Default DAC speed */
#define VDAC8_1_DEFAULT_SPEED    2
 /* Default Control */
#define VDAC8_1_DEFAULT_CNTL      0x00u
/* Default Strobe mode */
#define VDAC8_1_DEFAULT_STRB     0
 /* Initial DAC value */
#define VDAC8_1_DEFAULT_DATA     100
 /* Default Data Source */
#define VDAC8_1_DEFAULT_DATA_SRC 0
