...
# Date: Mon, 14 Jan 2013 02:04:50 GMT
#set_units -time ns
...
create_clock -name {ClockBlock/aclk_0} -period 500 -waveform {0 250} [get_pins {ClockBlock/aclk_0}]
create_clock -name {ClockBlock/dclk_3} -period 625 -waveform {0 312.5} [get_pins {ClockBlock/dclk_3}]
create_clock -name {ClockBlock/dclk_4} -period 1083.3333333333333 -waveform {0 541.666666666667} [get_pins {ClockBlock/dclk_4}]
...
create_generated_clock -name {ADC_1_theACLK} -source [get_pins {ClockBlock/clk_sync}] -divide_by 16 -duty_cycle 50 -nominal_period 500 [list [get_pins {ClockBlock/aclk_glb_0}]]
...
create_generated_clock -name {IMU_IntClock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 35 71} -nominal_period 1083.3333333333333 [list [get_pins {ClockBlock/dclk_glb_4}]]
...
# Project: C:\Users\Frank\Documents\PSoC Creator\IGVC2013\PSoC uC-slave\IGVC 2013.cydsn\IGVC 2013.cyprj
# Date: Mon, 14 Jan 2013 02:04:29 GMT
