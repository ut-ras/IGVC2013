...
typedef struct _Opamp_2_backupStruct
{
    uint8   enableState;
...
/* Power constants for SetPower() function */
    ...
    #define Opamp_2_LOWPOWER  (0x01u)
    #define Opamp_2_MEDPOWER  (0x02u)
    #define Opamp_2_HIGHPOWER (0x00u)
#endif
...
#define Opamp_2_TRO_REG       (* (reg8 *) Opamp_2_ABuf__TR0)
#define Opamp_2_TRO_PTR       (  (reg8 *) Opamp_2_ABuf__TR0)
...
#if (CY_PSOC3_ES3 || CY_PSOC5_ES2)
    #define Opamp_2_PWR_LPOC        (0x00u)
    #define Opamp_2_PWR_LOW         (0x01u)
    #define Opamp_2_PWR_MEDIUM      (0x02u)
    #define Opamp_2_PWR_HIGH        (0x03u)
#else
    #define Opamp_2_PWR_LOW         (0x01u)
    #define Opamp_2_PWR_MEDIUM      (0x02u)
    #define Opamp_2_PWR_HIGH        (0x00u)
#endif
