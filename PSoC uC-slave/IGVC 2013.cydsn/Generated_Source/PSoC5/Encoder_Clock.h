...
void Encoder_Clock_SetDividerRegister(uint16 clkDivider, uint8 reset) ;
...
#define Encoder_Clock_SetDivider(clkDivider)         Encoder_Clock_SetDividerRegister(clkDivider, 1)
#define Encoder_Clock_SetDividerValue(clkDivider)    Encoder_Clock_SetDividerRegister((clkDivider) - 1, 1)
...
#define Encoder_Clock_SetPhaseValue(clkPhase)        Encoder_Clock_SetPhaseRegister((clkPhase) + 1)
#endif
