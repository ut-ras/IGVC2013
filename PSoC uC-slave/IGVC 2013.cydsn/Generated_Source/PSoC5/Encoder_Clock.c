...
{
    if (Encoder_Clock_CLKEN & Encoder_Clock_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void Encoder_Clock_SetModeRegister(uint8 clkMode) 
{
    Encoder_Clock_MOD_SRC |= clkMode & Encoder_Clock_MODE_MASK;
}
...
*
*******************************************************************************/
void Encoder_Clock_ClearModeRegister(uint8 clkMode) 
{
    Encoder_Clock_MOD_SRC &= ~clkMode | ~Encoder_Clock_MODE_MASK;
}
...
{
    return Encoder_Clock_MOD_SRC & Encoder_Clock_MODE_MASK;
}
...
void Encoder_Clock_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        Encoder_Clock_MOD_SRC =
            (Encoder_Clock_MOD_SRC & ~Encoder_Clock_SRC_SEL_MSK) | clkSource;
    }
